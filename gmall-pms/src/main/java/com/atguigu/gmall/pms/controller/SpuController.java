...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByPageAndCid(PageParamVo paramVo, @PathVariable("categoryId") Long cid) {
        PageResultVo pageResultVo = spuService.querySpuByPageAndCid(paramVo, cid);
